package cn.krisez.shareroute.widget;
...
import cn.krisez.shareroute.utils.ScreenUtils;
...
public class RefreshView extends LinearLayout {
    ...
    private void init() {
        initRefreshView();
       // initLoadMoreView();
        anim = ObjectAnimator.ofFloat(refreshView, "kr", 0.0f, 1.0f);
    ...
    private void initRefreshView() {
        ...
        bezierView = (BezierView) refreshView.findViewById(R.id.bview);
        ...
        resetData();
        bezierView.setOnAnimResetListener(new BezierView.OnAnimResetListener() {
            @Override
            public void onReset() {
    ...
    public void resetRefreshView() {
        Log.i("RefreshView", "resetRefreshView: 页面重置");
        bezierLock = false;
        lastTop = refreshTargetTop;
